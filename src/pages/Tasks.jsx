...
const Tasks = () => {
  ...
  const pandingTasks = tasks.filter((task) => task.status === "panding");
  const runningTasks = tasks.filter((task) => task.status === "running");
  const compliteTasks = tasks.filter((task) => task.status === "done");
